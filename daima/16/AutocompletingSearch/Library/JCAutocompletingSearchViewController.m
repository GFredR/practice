...
- (void) searchBar:(UISearchBar*)searchBar textDidChange:(NSString*)searchText {
  ...
  [self.delegate searchController:self performSearchForQuery:searchText withResultsHandler:^(NSArray* searchResults) {
    ...
    if (searchID >= currentlyDisplaySearchID) {
      ...
      NSLog(@"JCAutocompletingSearchController: received out-of-order search results; ignoring. (currently displayed: %lu, searchID: %lu", (unsigned long)currentlyDisplaySearchID, (unsigned long)searchID);
    }
    --loadingQueueCount;
