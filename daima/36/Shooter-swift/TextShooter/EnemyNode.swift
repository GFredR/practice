...
class EnemyNode: SKNode {
    ...
    override func receiveAttacker(_ attacker: SKNode, contact: SKPhysicsContact) {
        ...
        let path = Bundle.main().pathForResource("MissileExplosion",
                                                         ofType: "sks")
    ...
    private func initNodeGraph() {
        let topRow = SKLabelNode(fontNamed: "gxj-Bold")
        ...
        let middleRow = SKLabelNode(fontNamed: "gxj-Bold")
        middleRow.fontColor = SKColor.brown()
        middleRow.fontSize = 20
        middleRow.text = "x"
        addChild(middleRow)
        
        let bottomRow = SKLabelNode(fontNamed: "gxj-Bold")
